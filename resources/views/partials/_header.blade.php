                            ...
                            <ul class="iq-header-sub-menu list-unstyled collapse" id="homeData">
                                ...
                                <li class="nav-item">
                                    ...
                                    <ul aria-expanded="false" class="iq-header-sub-menu left list-unstyled collapse" id="menuStyles">
                                        ...
                                        <li class="nav-item"><a class="nav-link " href="index-dual-horizontal.html">Dual Horizontal Dashboard</a></li>
                                    ...
                                    <ul aria-expanded="false" class="iq-header-sub-menu left list-unstyled collapse" id="authSkins">
                                        ...
                                        <li class="nav-item">
                                            ...
                                            <ul aria-expanded="false" class="iq-header-sub-menu left list-unstyled collapse" id="animatedAuth">
                                                ...
                                                <li class="nav-item"><a class="nav-link " href="auth-pro/account-deactivate.html">Account deactivate</a></li>
                                            </ul>
                                        </li>
                                        <li class="nav-item">
            ...
            <ul class="mb-2 navbar-nav ms-auto align-items-center navbar-list mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        ...
                        <li><hr class="dropdown-divider"></li>
                        <li>
                            <a class="dropdown-item" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('deconnexion').submit();">
                                {{ __('Deconnexion') }}
                            </a>
                            <form id="deconnexion" action="{{ route('logout') }}" method="POST" class="d-none">
                                @csrf
                            </form>
                        </li>
                    </ul>
